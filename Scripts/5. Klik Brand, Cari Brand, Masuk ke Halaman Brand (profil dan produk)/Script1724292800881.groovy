...
WebUI.click(findTestObject('Object Repository/Page_www.1000saudara.com  Merchant/a_Brand'))

WebUI.setText(findTestObject('Object Repository/Page_/input_Mitra 1000s_txtSearchBrandlist'), 'grc')

WebUI.click(findTestObject('Object Repository/Page_/p_GRC Board'))

WebUI.click(findTestObject('Object Repository/Page_Profile/a_Product'))
